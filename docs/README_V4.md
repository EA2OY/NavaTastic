...
[![Auditoría V4](https://img.shields.io/badge/Auditor%C3%ADa%20V4-100%25%20PASS%20(Hardware%20Real)-brightgreen?logo=checkmarx&logoColor=white)](pdf/INFORME_AUDITORIA_ULTRA_EXHAUSTIVA_NAVATASTIC_V4.pdf)

</div>

> 📜 **DOCUMENTO HISTÓRICO DE REFERENCIA: NAVATASTIC ECLIPSE V4 (v4.3.3)**:  
> Este documento conserva la portada y especificaciones completas de la versión anterior **NavaTastic Eclipse V4 (v4.3.3)**. Para la versión actual con sincronización transparente bidireccional desde la App Oficial, Hop-Aware Timing y persistencia LoRa / Canal 0, consulta el **[README Principal de NavaTastic V5](../README.md)**.
