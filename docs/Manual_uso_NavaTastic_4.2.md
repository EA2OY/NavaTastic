...
1. **Monitoreo**: El firmware lee continuamente el voltaje. Si detecta un valor por debajo del umbral crítico (**3.4V - 3.5V**) durante **5 lecturas consecutivas** (espaciadas 200ms), se activa la secuencia de hibernación.
