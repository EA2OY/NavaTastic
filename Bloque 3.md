# Validation Report: Block 3 Execution
...
* Defined `HARDWARE_TX_POWER_LIMIT` as `8` and uncommented `SX126X_MAX_POWER` as `8`.

```cpp
#define SX126X_MAX_POWER 8
#define HARDWARE_TX_POWER_LIMIT 8
...
...
* Added `<nrf_soc.h>` inclusion under `ARCH_NRF52`.
