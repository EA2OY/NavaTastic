...
#define NAVATASTIC_BUILD "V5" // bump manual por release: V3 (4.3.2) -> V4 (4.3.3) -> V5 (4.3.4+, publicacion 29/08)
#endif
...
// al actualizar — claves/canales/nombre/rol se re-absorben solos desde la config).
